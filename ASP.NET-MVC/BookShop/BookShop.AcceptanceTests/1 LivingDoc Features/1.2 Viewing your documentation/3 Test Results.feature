...
The following examples from our [Bookshop Example](<BookShop.AcceptanceTests/2 Example - Bookshop Specifications/Book Details.feature>) demonstrate scenarios with the different states. 
