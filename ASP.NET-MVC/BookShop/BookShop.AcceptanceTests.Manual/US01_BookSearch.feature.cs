...
namespace BookShop.AcceptanceTests.Manual
{
...
#line 15
testRunner.When("I perform a simple search on \'Domain\' (manual)");
#line 16
testRunner.Then("the book list should exactly contain book \'Domain Driven Design\' (manual)");
#line hidden
