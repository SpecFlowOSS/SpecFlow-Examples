...
namespace CommunityContentSubmissionPage.Specs.Pages
{
    public static class SubmissionPage
    {
        ...
        public static IWebLocator PrivacyPolicyLabel =>
            L("privacy policy checkbox", By.CssSelector("#chkPrivacyPolicy label"));

        public static IWebLocator PrivacyPolicyError =>
            L("privacy policy checkbox", By.CssSelector("#privacypolicy span"));
